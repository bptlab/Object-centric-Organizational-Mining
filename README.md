...
In the `Object Type DFGs` folder, the DFGs of all objects types of all adapted OCELs can be found, as well as the constructor, which computes all DFGs for one OCEl. Furthermore, also a script can be found that visualizes the DFGs.
